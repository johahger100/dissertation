...
//                }
    ...
    private void processVoiceAction(String command) {
        ...
        //ActivityManager.MemoryInfo memInfor = new ActivityManager.MemoryInfo();
        //((ActivityManager) getSystemService(ACTIVITY_SERVICE)).getMemoryInfo(memInfor);
        //Log.d("RAM_MINNE", String.valueOf(memInfor.totalMem));
        // Above code checks how much RAM the device has
