Overall the results show that Google Glass was slower than the smartphones in all stages of the application. Google Glass performed about half a second slower than the smartphones, where Samsung Galaxy SIII proved to be faster than Samsung Galaxy SII. Using different complexities of the QR code Google Glass was only able to read the QR code encoding one character. The Samsung Galaxy SII managed to read the QR code encoding 50 characters, however not the QR code encoding 100 characters. The Samsung Galaxy SIII managed to read all three of the QR codes which represented three increasing levels of complexity.
